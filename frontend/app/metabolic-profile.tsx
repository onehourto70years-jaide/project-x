...
const styles = StyleSheet.create({
  ...
  identityPrimary: { fontSize: 20, fontWeight: 'bold', color: '#fff', marginTop: 4 },
  ...
  evolutionNote: { fontSize: 12, color: '#888', marginTop: 8, fontStyle: 'italic', lineHeight: 16 },
  ...
  engineLabel: { fontSize: 14, fontWeight: '700', color: '#aaa', marginTop: 4 },
  engineSub: { fontSize: 11, color: '#666', marginTop: 2 },
