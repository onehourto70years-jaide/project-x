    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.centered}>
          <Ionicons name="barcode-outline" size={64} color={theme.accent} />
      ...
      {!product ? (
        <View style={styles.scannerContainer}>
          ...
          <View style={styles.overlay}>
            ...
            {loading && <ActivityIndicator size="small" color={theme.accent} style={{ marginTop: 12 }} />}
          </View>
        </View>
      ) : (
        <View style={styles.productContainer}>
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity style={[styles.actionBtn, styles.actionBtnSecondary]} onPress={resetScanner}>
              <Ionicons name="scan" size={20} color={theme.text} />
              <Text style={styles.actionBtnText}>{t('scan_again')}</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.actionBtn, styles.actionBtnPrimary]} onPress={addToLog}>
...
const makeStyles = (theme: ThemeColors) => StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: 'bold', color: theme.text, marginTop: 16 },
  text: { color: theme.textMuted, marginTop: 8, textAlign: 'center', paddingHorizontal: 20 },
  button: { backgroundColor: theme.accent, paddingHorizontal: 24, paddingVertical: 14, borderRadius: 12, marginTop: 24 },
  buttonSecondary: { backgroundColor: theme.bgInput, marginTop: 12 },
  ...
  corner: { position: 'absolute', width: 30, height: 30, borderColor: theme.accent, borderWidth: 3 },
  ...
  productCard: { backgroundColor: theme.bgCard, borderRadius: 16, padding: 20 },
  productName: { fontSize: 20, fontWeight: 'bold', color: theme.text, marginBottom: 4 },
  productBrand: { fontSize: 14, color: theme.textMuted, marginBottom: 16 },
  nutrientsCard: { backgroundColor: theme.bgInput, borderRadius: 12, padding: 16, marginTop: 12, marginBottom: 16 },
  nutrientsTitle: { fontSize: 14, color: theme.textMuted, marginBottom: 12 },
  nutrientRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  nutrientLabel: { color: theme.textSecondary, fontSize: 14 },
  nutrientValue: { color: theme.text, fontWeight: '600', fontSize: 14 },
  allergensCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: `${theme.danger}18`, padding: 12, borderRadius: 8 },
  allergensText: { color: theme.danger, marginLeft: 8, fontSize: 13, flex: 1 },
  ...
  actionBtnSecondary: { backgroundColor: theme.bgInput },
